...
/** 
 * Responsavel por definir os valores que o Builder carrega para cada caso 
 * de instanciamento de SaldoFerias.
 */
public class SaldoFeriasDirector {
	 ...
	 * @param identificadorUsuario String que representa o identificador de 
	 * um colaborador no banco de dados
	 * @param dataAdmissao LocalDate que representa a data de contratacao do 
	 * colaborador, vem do controle de funcionarios
	 */
